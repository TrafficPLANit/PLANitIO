...
public class PlanItIOIntegrationTest {
	...
	public void testBasic1OneInitialCostFile() {
		try {
			...
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName,
					xmlFileName);
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName,
					xmlFileName);
		} catch (Exception e) {
	...
	public void testBasicShortestPathAlgorithmAtoC() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(11, 12, 1, 8, 30, 2000, 8, 1));
	...
	public void testBasicShortestPathAlgorithmAtoD() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(8, 9, 1, 20, 42, 2000, 20, 1));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(6, 11, 1, 12, 54, 2000, 12, 1));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(12, 7, 1, 5, 59, 2000, 5, 1));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(9, 14, 1, 10, 69, 2000, 10, 1));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(11, 12, 1, 8, 77, 2000, 8, 1));
			resultsMap.get(timePeriod).get(mode1)
	...
	public void testBasicThreeTimePeriods() {
		try {
			...
			runFileEqualAssertionsAndCleanUp(OutputType.LINK, projectPath, "RunId 0_" + description, csvFileName3,
					xmlFileName3);
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName1,
					xmlFileName1);
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName2,
					xmlFileName2);
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName3,
					xmlFileName3);
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName1,
					xmlFileName1);
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName2,
					xmlFileName2);
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName3,
					xmlFileName3);
		} catch (Exception e) {
			PlanItLogger.severe(e.getMessage());
			fail(e.getMessage());
	...
	public void testRouteChoiceCompareWithOmniTRANS1() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(13, 4, 1000, 0.01, 250.0000313, 20000, 1, 99.9996875));
			resultsMap.get(timePeriod).get(mode1)
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(12, 6, 1000, 0.01, 280.6250625, 20000, 1, 99.9996875));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(15, 5, 1000, 0.01, 290.6250938, 20000, 1, 99.9996875));
			resultsMap.get(timePeriod).get(mode1)
			...
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName, xmlFileName);
		} catch (Exception e) {
			PlanItLogger.severe(e.getMessage());
			fail(e.getMessage());
		}
	...
	public void testRouteChoiceCompareWithOmniTRANS2() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(1, 4, 1879.2, 0.0667837, 214.8106084, 1200, 1, 14.9737025));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(4, 12, 3600, 0.025, 304.8106084, 3600, 1, 40));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(1, 2, 295.2, 0.0333944, 314.6687712, 1200, 2, 59.8903352));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(2, 4, 295.2, 0.0333944, 324.526934, 1200, 2, 59.8903352));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(1, 3, 1425.6, 0.0332658, 372.1408694, 1200, 1, 30.0609344));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(3, 4, 1425.6, 0.0332658, 419.7548048, 1200, 1, 30.0609344));
			TestHelper.compareResultsToMemoryOutputFormatter(OutputType.LINK, memoryOutputFormatter, maxIterations,
					resultsMap);
			runFileEqualAssertionsAndCleanUp(OutputType.LINK, projectPath, "RunId 0_" + description, csvFileName,	xmlFileName);
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName, xmlFileName);
	...
	public void testRouteChoiceCompareWithOmniTRANS3() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(1, 3, 4048, 0.0531495, 456.2280829, 3000, 2, 37.6297041));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(1, 2, 3952, 0.0239029, 550.566099, 5000, 2, 83.6718462));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(2, 3, 3952, 0.0295286, 666.954771, 4000, 2, 67.7310119));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(3, 5, 4144, 0.2043143, 1519.774245, 2000, 2, 9.7888406));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(3, 4, 3856, 0.0472937, 1701.235183, 3000, 2, 42.2888931));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(4, 5, 3856, 0.1581746, 2306.581184, 2000, 2, 12.6442576));
			resultsMap.get(timePeriod).get(mode1)
	...
	public void testRouteChoiceCompareWithOmniTRANS4() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(12, 11, 482.4, 0.0301605, 14.58482622, 1500, 3, 99.4679928));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(11, 12, 482.4, 0.0301605, 29.13485243, 1500, 3, 99.4679928));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(12, 16, 483, 0.0100538, 33.99102332, 1500, 1, 99.4653552));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(16, 12, 483, 0.0100538, 38.84719421, 1500, 1, 99.4653552));
			resultsMap.get(timePeriod).get(mode1)
			...
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(11, 15, 500, 0.0100617, 45.29830657, 1500, 1, 99.3865031));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(15, 11, 500, 0.0100617, 50.32941893, 1500, 1, 99.3865031));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(1, 5, 899.4, 0.0106463, 59.90467441, 1500, 1, 93.9295781));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(5, 1, 899.4, 0.0106463, 69.47992989, 1500, 1, 93.9295781));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(1, 4, 1087.4, 0.0102428, 80.61584489, 1500, 0.9, 87.8665119));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(4, 1, 1087.4, 0.0102428, 91.75175988, 1500, 0.9, 87.8665119));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(1, 2, 1012, 0.0099323, 101.804863, 1500, 0.9, 90.613182));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(2, 1, 1012, 0.0099323, 111.857966, 1500, 0.9, 90.613182));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(2, 6, 1582.4, 0.0161926, 137.4801958, 1500, 1, 61.756766));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(6, 2, 1582.4, 0.0161926, 163.1024255, 1500, 1, 61.756766));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(2, 3, 994.4, 0.0109657, 174.0082393, 1500, 1, 91.1933155));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(3, 2, 994.4, 0.0109657, 184.9140531, 1500, 1, 91.1933155));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(3, 7, 1900, 0.0228712, 228.3178046, 1500, 1, 43.7230914));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(7, 3, 1900, 0.0228712, 271.7215562, 1500, 1, 43.7230914));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(3, 4, 905.6, 0.0106643, 281.3754383, 1500, 1, 93.7709887));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(4, 3, 905.6, 0.0106643, 291.0293204, 1500, 1, 93.7709887));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(4, 8, 1617, 0.0167522, 318.0915022, 1500, 1, 59.693666));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(8, 4, 1617, 0.0167522, 345.153684, 1500, 1, 59.693666));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(16, 23, 483, 0.0200001, 354.8137105, 10000, 1, 49.9998639));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(23, 16, 483, 0.0200001, 364.473737, 10000, 1, 49.9998639));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(23, 8, 1617, 0.0200068, 396.8247653, 10000, 1, 49.9829143));
			resultsMap.get(timePeriod).get(mode1)
					.add(new LinkSegmentExpectedResultsDto(8, 23, 1617, 0.0200068, 429.1757937, 10000, 1, 49.9829143));
			resultsMap.get(timePeriod).get(mode1)
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(21, 5, 899.4, 0.0200007, 447.1883822, 10000, 1, 49.9983642));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(5, 21, 899.4, 0.0200007, 465.1769707, 10000, 1, 49.9983642));
			resultsMap.get(timePeriod).get(mode1)
			...
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(22, 6, 1582.4, 0.0200063, 497.5388914, 10000, 1, 49.98433));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(6, 22, 1582.4, 0.0200063, 529.1968121, 10000, 1, 49.98433));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(15, 24, 500, 0.0200001, 539.1968436, 10000, 1, 49.9998438));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(24, 15, 500, 0.0200001, 549.1968751, 10000, 1,49.9998438));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(24, 7, 1900, 0.020013, 587.2215839, 10000, 1, 49.967441));
			resultsMap.get(timePeriod).get(mode1).add(
					new LinkSegmentExpectedResultsDto(7, 24, 1900, 0.020013, 625.2462927, 10000, 1, 49.967441));
			TestHelper.compareResultsToMemoryOutputFormatter(OutputType.LINK, memoryOutputFormatter, maxIterations,
					resultsMap);
			runFileEqualAssertionsAndCleanUp(OutputType.LINK, projectPath, "RunId 0_" + description, csvFileName,
					xmlFileName);
	...
	public void testRouteChoiceCompareWithOmniTRANS5() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(4, 12, 3000, 0.0370117, 360.201299039938, 3600.0, 1.0, 27.0184697));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(1, 2, 6, 0.0447625, 360.470425354635, 1200.0, 2.0, 44.6802634));
			...
			resultsMap.get(timePeriod).get(mode2).add(new LinkSegmentExpectedResultsDto(1, 2, 1086, 0.0609332, 257.397693017887, 1200.0, 2.0, 32.8228128));
			resultsMap.get(timePeriod).get(mode2).add(new LinkSegmentExpectedResultsDto(2, 4, 1086, 0.0609332, 323.775777979144, 1200.0, 2.0, 32.8228128));
			resultsMap.get(timePeriod).get(mode2).add(new LinkSegmentExpectedResultsDto(1, 3, 414, 0.0613639, 349.067549843147, 1200.0, 1.0, 16.296231));
			resultsMap.get(timePeriod).get(mode2).add(new LinkSegmentExpectedResultsDto(3, 4, 414, 0.0613639, 374.359321707149, 1200.0, 1.0, 16.296231));
			TestHelper.compareResultsToMemoryOutputFormatter(OutputType.LINK, memoryOutputFormatter, maxIterations, resultsMap);
			runFileEqualAssertionsAndCleanUp(OutputType.LINK, projectPath, "RunId 0_" + description, csvFileName, xmlFileName);
			runFileEqualAssertionsAndCleanUp(OutputType.OD, projectPath, "RunId 0_" + description, csvFileName, xmlFileName);
			runFileEqualAssertionsAndCleanUp(OutputType.OD_PATH, projectPath, "RunId 0_" + description, csvFileName, xmlFileName);
	...
	public void testRouteChoiceCompareWithOmniTRANS5IdentifyLinksById() {
		try {
			...
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(2, 3000, 0.0370117, 360.201299039938, 3600.0, 1.0, 27.0184697));
			resultsMap.get(timePeriod).get(mode1).add(new LinkSegmentExpectedResultsDto(3, 6, 0.0447625, 360.470425354635, 1200.0, 2.0, 44.6802634));
			...
			resultsMap.get(timePeriod).get(mode2).add(new LinkSegmentExpectedResultsDto(3, 1086, 0.0609332, 257.397693017887, 1200.0, 2.0, 32.8228128));
