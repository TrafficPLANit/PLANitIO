 ...
 *
 */
public class XmlMacroscopicLinkSegmentTypeHelper {

  /** the logger */
  private static final Logger LOGGER = Logger.getLogger(XmlMacroscopicLinkSegmentTypeHelper.class.getCanonicalName());
  
  /**
   * Map of existing link types
   */
  private static Map<Object, XmlMacroscopicLinkSegmentTypeHelper> existingLinkTypeHelpers;  
  ...
  public static void reset() {
    existingLinkTypeHelpers = new HashMap<Object, XmlMacroscopicLinkSegmentTypeHelper>();
  }
   ...
   */
  public XmlMacroscopicLinkSegmentTypeHelper(
    ...
    if (existingLinkTypeHelpers.containsKey(xmlId)) {
      XmlMacroscopicLinkSegmentTypeHelper other = existingLinkTypeHelpers.get(xmlId);
