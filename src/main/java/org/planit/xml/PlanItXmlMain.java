...
public class PlanItXmlMain {
    ...
    private String networkFileLocation = "src\\test\\resources\\route_choice\\test5\\network.csv"; 
    private String demandFileLocation =   "src\\test\\resources\\route_choice\\test5\\demands.csv";
    private String routeTypesFileLocation ="src\\test\\resources\\route_choice\\test5\\link_types.csv";
    private String zoneFileLocation =  "src\\test\\resources\\route_choice\\test5\\zones.csv"; 
    private String timePeriodFileLocation = "src\\test\\resources\\route_choice\\test5\\time_periods.csv"; 
    private String modeFileLocation = "src\\test\\resources\\route_choice\\test5\\modes.csv";
    private String resultsFileLocation = "src\\test\\resources\\route_choice\\test5\\results.csv";
 ...
 */
	public void execute() throws PlanItException {
		...
		IdGenerator.reset();
		InputBuilderListener inputBuilderListener = new PlanItXml(networkFileLocation, demandFileLocation, routeTypesFileLocation, zoneFileLocation, timePeriodFileLocation, modeFileLocation);
